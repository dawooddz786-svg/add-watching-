      ...
      >
        <div className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 mt-2">Sign in with your Email or Gmail</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-2">Email or Gmail Address</label>
